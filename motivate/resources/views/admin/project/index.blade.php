                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'project_name'">{{ trans('admin.project.columns.project_name') }}</th>
                                        <th is='sortable' :column="'project_due'">{{ trans('admin.project.columns.project_due') }}</th>
                                        <th is='sortable' :column="'user_id'">{{ trans('admin.project.columns.user_id') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.project_due | datetime }}</td>
                                        <td>@{{ item.user_id }}</td>
